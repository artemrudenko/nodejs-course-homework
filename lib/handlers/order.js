...
lib._order.post = (data, callback) => {
  // Validate inputs
  let cardNumber = typeof (data.payload.cardNumber) === 'string' && data.payload.cardNumber.trim().length == 16
